# Logs Bot — Project Notes for Claude

Keep this file **tight**. It's auto-loaded every session. For anything long, put it in
`C:\Users\min\Desktop\Claude .md files\` and read it on demand.
...
- Core logic: `core/*.py`
- Extended notes (read on demand): `C:\Users\min\Desktop\Claude .md files\`
